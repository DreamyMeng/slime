(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":720,"designHeight":1280,"scaleMode":"fixedauto","alignV":"middle","alignH":"center","screenMode":"vertical","backgroundColor":"rgba(0, 0, 0, 1)"},"2D":{"useRetinalCanvas":true,"defaultFont":"font/AlimamaDaoLiTi.woff2","FPS":60,"isAntialias":true,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true,"defaultFontSize":20},"splash":{"enabled":false,"fit":"center","duration":1},"stat":false,"3D":{"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":32,"lightClusterCount":{"x":12,"y":12,"z":12},"maxMorphTargetCount":32},"physics2D":{"allowSleeping":true,"gravity":{"x":0,"y":9.8},"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawAABB":false,"drawCenterOfMass":false,"layers":["Default"]},"physics3D":{"fixedTimeStep":0.016666666666666666,"maxSubSteps":1,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001,"layers":["Default"]},"addons":{},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","vConsole":false,"alertGlobalError":false,"dcc":{"enable":false,"generate":false,"version":"1.0.0","desc":"update resources","reserveOld":true},"startupScene":"Scene.ls","pkgs":[{"path":"","autoLoad":true}]}`);
